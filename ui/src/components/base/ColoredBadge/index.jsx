...
const ColoredBadge = ({ label, labelToSelectColor: _labelToSelectColor }) => {
  const labelToSelectColor = _labelToSelectColor || label
  const colorKey = COLORS[hashStringToIndex(labelToSelectColor, COLORS.length)]
